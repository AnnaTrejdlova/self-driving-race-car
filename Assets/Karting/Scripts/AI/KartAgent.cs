...
#region Debugging
        ...
        private void OnGUI()
        {
            GUILayout.Label("Accel: " + m_Acceleration.ToString());
            GUILayout.Label("Brake: " + m_Brake.ToString());
            GUILayout.Label("Steer: " + m_Steering.ToString());
            GUILayout.Label("Sim speed: " + Time.timeScale);
            GUILayout.HorizontalSlider(1f, 1f, 100f);
        }
    }
}
